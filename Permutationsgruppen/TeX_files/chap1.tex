...
\begin{remark}
	...
	%		\end{picture}
\end{remark}
i.A. Lösung: Anzahl lässt sich als die Anzahl der sogenannten ``Bahnen'' (eng. Orbit) einer Permutationsgruppe beschrieben. (bestimmbar mit Lemma von \person{Cauchy}-\person{Frobenius}-Burnside). $\implies$ Abzählbartheoreme (\person{Polya}).
\begin{example}
